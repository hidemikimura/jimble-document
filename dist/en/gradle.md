...
plugins {
	application
	id("io.jimble.jte") version "1.0.1"   // if you use src/main/jte
	id("io.jimble.run") version "1.0.1"   // if you want hot reload
	id("io.jimble.db")  version "1.0.1"   // if you use a database
}
